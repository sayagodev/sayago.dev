...
export function CustomCursor() {
    ...
    useEffect(() => {
        ...
        const isPointerTarget = (el: Element | null) => {
            ...
            if (el.closest('a, button, [role="button"], input, select, textarea, summary, [data-cursor="pointer"]')) {
                return true
            }
        ...
        <>
            ...
            >
                ...
                <div className="relative">
                    ...
                    <div className="relative size-3 rounded-full bg-cursor" />
                </div>
            </motion.div>
            ...
            >
                ...
                <div
                    ...
                    className={[
                        ...
                        isPointer
                            ? "h-8 w-8 border border-cursor/90 bg-cursor/5"
                            : "h-6 w-6 border border-cursor/80 bg-transparent",
                    ].join(" ")}
                />
            </motion.div>
        </>
